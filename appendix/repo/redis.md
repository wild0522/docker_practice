...
### 基本資訊
[Redis](https://en.wikipedia.org/wiki/Redis) 是開源的 記憶體 Key-Value 資料庫實作。

該倉庫位於 https://hub.docker.com/_/redis/，提供了 Redis 3.x 各個版本的映像檔。
...
```
另外還可以啟動 [持久儲存](http://redis.io/topics/persistence)。
